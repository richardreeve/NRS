...
namespace NRS
{
  ...
  namespace Simulator
  {
    /// Poisson neurons are stochastic generators of spikes
    class PoissonNeuron : public Unit::Time, public Base::Node
    {
    public:
      /// Constructor
      /**
       ...
       * \param aNFptr pointer to NodeFactory
       *
       **/
      PoissonNeuron( std::string aName, const Base::NodeFactory *aNFptr );
