...
#ifndef _REVERSIBLECONDUCTANCE_MANAGER_HH
#define _REVERSIBLECONDUCTANCE_MANAGER_HH
...
namespace NRS
{
  namespace Message
  {
    /// The manager for the Number Variable type.
    /** 
     *
     * This is the base class for all managers of Variables with 1 numeric
     * argument - Variables of Number type.
     *
     **/
    class ReversibleConductanceManager : public Base::VariableManager
    {
    public:
      /// Default constructor.
      /**
       *
       * This is the constructor for the basic NumberManager.
       *
       **/
      ReversibleConductanceManager();

      /// Destructor.
      virtual ~ReversibleConductanceManager()
      {
      }
...
#endif //ndef _REVERSIBLECONDUCTANCE_MANAGER_HH
