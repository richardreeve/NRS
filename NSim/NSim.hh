...
namespace NRS
{
  /// Namespace for elements of the neural simulator component
  namespace Simulator
  {
    /// Class for root Node of neural simulator
    class NSim : public Type::Void, public Base::Node
    {
    public:
      /// Constructor
      /**
       ...
       *
       **/
      NSim( std::string aName, const Base::NodeFactory *aNFptr ) :
