...
namespace NRS
{
  ...
  namespace Simulator
  {
    /// Simple container class for neural elements
    class Network : public Type::Void, public Base::Node
    {
    public:
      /// Default constructor
      /**
       ...
       *
       **/
      Network( std::string aName, const Base::NodeFactory *aNFptr ) :
