...
namespace
{
  NRS::Message::ReplyMaxVNIDManager sRMaxVNIDM;
}

NRS::Message::ReplyMaxVNIDManager::ReplyMaxVNIDManager() : 
  VariableManager( Literals::Object::REPLYMAXVNID_VARIABLE(), "", 2 )
{
...
void NRS::Message::ReplyMaxVNIDManager::doConfigure()
{
...
void
NRS::Message::ReplyMaxVNIDManager::createVariable( const std::string &aName )
  const
{
  new ReplyMaxVNID( aName );
}
