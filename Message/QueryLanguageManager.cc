...
namespace
{
  NRS::Message::QueryLanguageManager sQLanguageM;
}

NRS::Message::QueryLanguageManager::QueryLanguageManager() : 
  QueryManager( Literals::Object::QUERYLANGUAGE_VARIABLE(), "", 3 )
{
}

void NRS::Message::QueryLanguageManager::setSegments()
{
  QueryManager::setSegments();
}

void NRS::Message::QueryLanguageManager::setDescription()
{
  iDescription = "The built-in message for queries of "
    "languages capabilities";
}

void NRS::Message::QueryLanguageManager::createVariable( std::string aName )
{
  new QueryLanguage ( aName );
}

// tells the manager to deliver data from a PML message to QueryLanguage
bool
NRS::Message::QueryLanguageManager::deliverMessage( unsigned_t vnid,
						    std::map< std::string,
						    ...
						    const char *contents )
{
  ...
  dynamic_cast< QueryLanguage* >( theVND.getVariable( vnid ))->
...
bool 
NRS::Message::QueryLanguageManager::translateMessage( unsigned_t port,
...
bool NRS::Message::QueryLanguageManager::deliverMessage( unsigned_t vnid,
							 char *&data,
							 bool intelligent,
							 const char* intMap[] )
{
...
void 
NRS::Message::QueryLanguageManager::sendMessage( Base::Target &theTarget,
						 Base::Target &returnTarget,
						 unsigned_t msgID )
{
  Base::ExternalInterfaceDirector &theEID =
