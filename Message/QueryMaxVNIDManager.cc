...
namespace
{
  NRS::Message::QueryMaxVNIDManager sQMaxVNIDM;
}

NRS::Message::QueryMaxVNIDManager::QueryMaxVNIDManager() : 
  VariableManager( Literals::Object::QUERYMAXVNID_VARIABLE(), "", 3 )
{
...
void NRS::Message::QueryMaxVNIDManager::doConfigure()
{
...
void
NRS::Message::QueryMaxVNIDManager::createVariable( const std::string &aName )
  const
{
  new QueryMaxVNID( aName );
}
