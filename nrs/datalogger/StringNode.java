...
/** Represents node to log string messages for this component
 * 
...
public class StringNode extends Node
{
  ...
  private final static String type = "StringNode";
   ...
   */
  public StringNode(VariableManager vmMan, String name)
  {
    ...
    //register Value variable with VariableManager
    String varName3 = name+ ".Value";
    m_varValue = new StringType(vmMan, varName3, true, false){
        public void deliver(Message m)
        {
          handleMessageAt_Value(m, this, checkType(m, this));
        }
        public void deliver(String s){
          handleMessageAt_Value(s);
        }
      };
    //add Value variable to this Node localVars
  ...
  { 
    ...
    String s = m_varValue.extractData(m);
    if ( s != null )
      handleMessageAt_Value(s);
  }
  /**
   * Process the receipt of a message at the Value variable.
   */
  public void handleMessageAt_Value(String s) 
  { 
    PackageLogger.log.fine("Received message at " + getVNName() 
                           + ":Value variable!");
    m_varValue.setValue(s);
