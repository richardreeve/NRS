...
/** Represents node to log boolean messages for this component
 * 
...
public class BooleanNode extends Node
{
  ...
  private BooleanType m_varValue;
  ...
  private final static String type = "BooleanNode";
   ...
   */
  public BooleanNode(VariableManager vmMan, String vnName)
  {
    ...
    m_varValue = new BooleanType(vmMan, varName3, true, false){
        public void deliver(Message m)
        {
    ...
    String varName5 = vnName+ ".Filename";
    ...
    String varName6 = vnName+ ".AppendToFile";
  ...
  { 
    ...
    Boolean b = m_varValue.extractData(m);
    
    handleMessageAt_Value(b.booleanValue());
  }
  /**
   * Process the receipt of a message at the Value variable.
   */
