...
/** Main Wrapper component application manager.
 * Manages all resources for Wrapper component.
...
public class AppManager extends BaseAppManager
{
  ...
  public static final String NAME = "NRS.wrapper";
  ...
  //static final Logger logger = Logger.getLogger ("nrs.wrapper");
  
  /** Runtime reference for this JVM. */
  ...
  private AppManager(){
    ...
    // get Runtime object for the current JVM
  ...
  public String getCSLFile(){
    return m_prefs.get("CSL_FILE", "wrapper.xml");
  }
  ...
  protected BaseComponent buildComponent(VariableManager vmMan){
    return new WrapperComponent(vmMan);
  }
