...
/** Class to represent the Voltage unit.
 *
 * @author Thomas French
 */

public abstract class Voltage extends FloatType
{
  /** Default Constructor
   *
   ...
   */
  public Voltage(VariableManager vm, String name, 
              boolean stateHolding, boolean selfUpdating){
    super(vm, name, stateHolding, selfUpdating, "Voltage");
    
    // set Voltage restriction
    setRestriction(new FloatRestriction("V", "m"));
  }
