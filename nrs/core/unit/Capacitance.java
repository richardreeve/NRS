...
/** Class to represent the Capacitance unit.
 *
 * @author Thomas French
 */

public abstract class Capacitance extends FloatType
{
  /** Default Constructor
   *
   ...
   */
  public Capacitance(VariableManager vm, String name, 
              boolean stateHolding, boolean selfUpdating){
    super(vm, name, stateHolding, selfUpdating, "Capacitance");
    
    // set Capacitance restriction
    setRestriction(new FloatRestriction("F", "p", 0, Double.MAX_VALUE));
  }
