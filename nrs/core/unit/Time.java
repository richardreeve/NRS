...
/** Class to represent the Time unit.
 *
 * @author Thomas French
 */

public abstract class Time extends FloatType
{
  /** Default Constructor
   *
   ...
   */
  public Time(VariableManager vm, String name, 
              boolean stateHolding, boolean selfUpdating){
    super(vm, name, stateHolding, selfUpdating, "Time");
    
    // set Time restriction
    setRestriction(new FloatRestriction("s", "m", 0, Double.MAX_VALUE));
  }
