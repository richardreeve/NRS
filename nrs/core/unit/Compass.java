...
/** Class to represent the Compass unit.
 *
 * @author Thomas French
 */

public abstract class Compass extends StringType
{
  /** Default Constructor
   *
   ...
   */
  public Compass(VariableManager vm, String name, 
                 boolean stateHolding, boolean selfUpdating){
    super(vm, name, stateHolding, selfUpdating, "Compass");
    
    // set Compass restriction
    StringRestriction r = new StringRestriction(StringRestriction.Type.List);
    r.addListMember("north");
    r.addListMember("south");
    r.addListMember("west");
    r.addListMember("east");
    setRestriction(r);
  }
