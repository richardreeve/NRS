...
/** Class to represent the Current unit.
 *
 * @author Thomas French
 */

public abstract class Current extends FloatType
{
  /** Default Constructor
   *
   ...
   */
  public Current(VariableManager vm, String name, 
              boolean stateHolding, boolean selfUpdating){
    super(vm, name, stateHolding, selfUpdating, "Current");
    
    // set Current restriction
    setRestriction(new FloatRestriction("A", "p"));
  }
