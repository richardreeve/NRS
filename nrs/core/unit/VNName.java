...
/** Class to represent the VNName unit.
 *
 * @author Thomas French
 */

public abstract class VNName extends StringType
{
  /** Default Constructor
   *
   ...
   */
  public VNName(VariableManager vm, String name, 
                boolean stateHolding, boolean selfUpdating){
    super(vm, name, stateHolding, selfUpdating, "vnname");
    
    // set Token restriction
    setRestriction(new StringRestriction(StringRestriction.Type.VNName));
  }
