...
/** Class to represent the Frequency unit.
 *
 * @author Thomas French
 */

public abstract class Frequency extends FloatType
{
  /** Default Constructor
   *
   ...
   */
  public Frequency(VariableManager vm, String name, 
              boolean stateHolding, boolean selfUpdating){
    super(vm, name, stateHolding, selfUpdating, "Frequency");
    
    // set Frequency restriction
    setRestriction(new FloatRestriction("Hz", "", 0, Double.MAX_VALUE));
  }
