...
/** Class to represent the Token unit.
 *
 * @author Thomas French
 */

public abstract class Token extends StringType
{
  /** Default Constructor
   *
   ...
   */
  public Token(VariableManager vm, String name, 
               boolean stateHolding, boolean selfUpdating){
    super(vm, name, stateHolding, selfUpdating, "token");
    
    // set Token restriction
    setRestriction(new StringRestriction(StringRestriction.Type.Token));
  }
