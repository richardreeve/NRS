...
/** Class to represent route variables.
 *
 * _TODO_ Need to check values are legal NRS Routes.
 *
 * @author Thomas French
 */

public abstract class RouteType extends Variable
{ 
   ...
   */
  public RouteType(VariableManager vm, String name, 
               boolean stateHolding, boolean selfUpdating){
    super(vm, name, stateHolding, selfUpdating, "route");
