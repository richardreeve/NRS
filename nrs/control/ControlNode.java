...
public class ControlNode extends Node{
  private final static String type = "ControlNode";
   ...
   */
  public ControlNode(VariableManager vmMan, String name){
    super(vmMan, name, type);

    AppManager.getInstance().getMainFrame().setTitle(name);
  }
  ...
  /** Method called by JVM garbage collector when no references left 
   * to object.
   */
