...
/** Represents TimeButtonNodes for the button component.  This class
...
public class TimeButtonNode extends Node implements ActionListener{

  /** GUI, <tt>MainFrame</tt>, to which Buttons are added. */
  private MainFrame m_mainFrame;
  
  /** JButton which belongs to this <tt>TimeButtonNode</tt>. */
  private JButton m_button;
  /** JTextField which belongs to this <tt>TimeButtonNode</tt>. */
  private JTextField m_textField;
  /** JPanel which belongs to this <tt>TimeButtonNode</tt>. */
  private JPanel m_panel;
  
  /** <tt>TimeButtonNode</tt> variable Output. */
  private Time m_outputVar;
  ...
  private final static String type = "TimeButtonNode";
   ...
   */
  public TimeButtonNode(MainFrame mainFrame, VariableManager vmMan, 
                         String vnName){
    super(vmMan, vnName, type);
    m_mainFrame = mainFrame;
    
    String varName = vnName+ ".Output";
    m_outputVar = new Time(vmMan, varName, true, true){
  ...
  //--------------------------------------------------------------------//
  /**
   * Process the receipt of a message at the TimeButtonNode var - Output.
   *
   ...
   */
  public void deliver(Message m){
    PackageLogger.log.fine("Received message at TimeButtonNode: " 
                           + getVNName());
