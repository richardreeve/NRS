...
/** Main Control component application manager.
 * Manages all resources for Control component.
...
public class AppManager extends BaseAppManager
{
    ...
    public static final String NAME = "NRS.control";
    ...
    static final Logger logger = Logger.getLogger ("nrs.control");
	...
	return m_prefs.get("CSL_FILE", "control.xml");
    }
	...
	return new ControlComponent(vmMan);
    }
