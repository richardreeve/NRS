...
/** Main Composer component application manager.
 * Manages all resources for Composer component.
...
public class AppManager extends BaseAppManager
{
    ...
    public static final String NAME = "NRS.composer";
    ...
    static final Logger logger = Logger.getLogger ("nrs.composer");
	...
	return m_prefs.get("CSL_FILE", "composer.xml");
    }
	...
	return new ComposerComponent(vmMan);
    }
	...
	//build gui after parsing arguments
	m_mainFrame.buildGUI();
    }
