...
public class AppManager extends BaseAppManager
{
    ...
    public static final String NAME = "NRS.oscilloscope";
    ...
    {
	return m_prefs.get("CSL_FILE", "oscilloscope.xml");
    }
    ...
    {
	return new OscilloscopeComponent(vmMan);
    }
