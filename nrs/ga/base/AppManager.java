...
/** Main GA application manager.
 * Manages all resources for GA component.
...
public class AppManager extends BaseAppManager 
{
    ...
    public static final String NAME = "NRS.ga";
    ...
    static final Logger logger = Logger.getLogger ("nrs.ga");
	...
	return m_prefs.get("CSL_FILE", "ga.xml");
    }
