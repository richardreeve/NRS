...
/** TwoPointCrossoverNode.
 * Implements two point crossover, randomly selecting 
 * the parents and the two crossover points.
 * 
 * @author Thomas French
 */

public class TwoPointCrossoverNode extends CrossoverNode
{
  /** Constructor. 
   ...
   */
  public TwoPointCrossoverNode(VariableManager vmMan, String vnName){
    super(vmMan, vnName, "TwoPointCrossoverNode");
  }
  
  //-----------------------------------------------------------------------//
  /** {@link Message} to deliver to this Node. */
  public void deliver(Message m){
    PackageLogger.log.fine("Received message at TwoPointCrossoverNode!");
    super.deliver(m);
  }
  //-----------------------------------------------------------------------//
  /** Crossover
  ...
  public void crossover(ArrayList population, int index, 
    ...
    int counter = 1, popSize, index1, index2, cpoint1, cpoint2, size, 
      tempPoint, x;
    ...
    while ( counter <= Math.floor(popSize/2) ){
      ...
      if ( (rng.getRandInt(100)+1) <= getRate() ){
        ...
        cpoint1 = rng.getRandInt(size-1)+1; 
        cpoint2 = rng.getRandInt(size-1)+1; 
