...
/** ReplacementNode abstract class - represents nodes
 * to implement a 'replacement policy' for type Steady-State
 * Genetic Algorithm.
 *
 * @author Thomas French
 */

public abstract class ReplacementNode extends Node
{
   ...
   */
  public ReplacementNode(VariableManager vmMan, String vnName, String type){
  ...
  public void deliver(Message m){
    PackageLogger.log.fine("Received message at ReplacementNode!");
  }
  //---------------------------------------------------------------------//
  ...
  /** Replacement strategy - implemented by subclass.
   *
   * @param new_members potential new members (Chromosomes) to replace 
   * old individuals.
   * @param population list of Chromosomes in population.
   */
  public abstract void replace(ArrayList new_members, ArrayList population);
