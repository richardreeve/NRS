...
/** Main calculation application manager.
 * Manages all resources for calculation component.
...
public class AppManager extends BaseAppManager 
{
    ...
    public static final String NAME = "NRS.calculation";
    ...
    static final Logger logger = Logger.getLogger ("nrs.calculation");
	...
	return m_prefs.get("CSL_FILE", "calculation.xml");
    }
    ...
    {
	return new CalculationComponent(vmMan);
    }
