...
namespace NRS
{
  namespace Sample
  {
    /// Factory for Sample nodes, the root node for the simplest component type
    ...
    protected:
      ...
      {
	iDescription = "The root node of a sample simple component";
      }
	...
	// If all nodes in the sample group are declared to be part of
	// the "SampleGroup" group (in setGroups), then they will
	// appear in the GUI as child nodes of this parent.
	addContent( "SampleGroup", 1, -1, anARMap );
      }
