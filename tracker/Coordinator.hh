...
#ifndef _COORDINATOR_HH
#define _COORDINATOR_HH
...
namespace NRS
{
  namespace Tracker
  {
    class Coordinator : public Type::Void, public Base::Node
    {
    public:
      /// A Node representing a robot's position and configuration
      Coordinator( std::string aName, const Base::NodeFactory *aNF ) :
