...
#ifndef _FILE_BMF_INTERFACE_HH
#define _FILE_BMF_INTERFACE_HH
...
namespace NRS
{
  namespace Interface
  {
    /// This class instantiates BMF file readers and writers
    class FileBMFInterface : public FileInterface
    {
    public:
       ...
       *
       **/
      FileBMFInterface( std::string inFile, std::string outFile,
       ...
       *
       **/
      FileBMFInterface( std::string inFile, bool doRead, bool doWrite,
			bool instantTransmit, bool receiveAll,
			int maxReceive, int serialSpeed );
    };
  }
}
#endif //ndef _FILE_BMF_INTERFACE_HH
