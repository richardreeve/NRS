...
#ifndef _REPLY_MAX_VNID_MANAGER_HH
#define _REPLY_MAX_VNID_MANAGER_HH
...
namespace NRS
{
  namespace Message
  {
    /// The manager for the ReplyMaxVNID Variable type.
    /** 
     *
     * This is the base class for all managers of Variables which can
     * reply to qheries for max VNIDs
     *
     **/
    class ReplyMaxVNIDManager : public Base::VariableManager
    {
    public:
      /// Default constructor.
      /**
       *
       * This is the constructor for the basic ReplyMaxVNIDManager.
       *
       **/
      ReplyMaxVNIDManager();

      /// Destructor.
      virtual ~ReplyMaxVNIDManager()
      {
      }
...
#endif //ndef _REPLY_MAX_VNID_MANAGER_HH
