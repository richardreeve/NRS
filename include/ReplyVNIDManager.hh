...
#ifndef _REPLY_VNID_MANAGER_HH
#define _REPLY_VNID_MANAGER_HH
...
namespace NRS
{
  namespace Message
  {
    ...
    class ReplyVNIDManager : public Base::VariableManager
    {
    public:
      /// Default constructor.
      /**
       *
       * This is the constructor for the basic ReplyVNIDManager.
       *
       **/
      ReplyVNIDManager();

      /// Destructor.
      virtual ~ReplyVNIDManager()
      {
      }
...
#endif //ndef _REPLY_VNID_MANAGER_HH
