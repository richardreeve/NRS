...
#ifndef _QUERY_MAXPORT_MANAGER_HH
#define _QUERY_MAXPORT_MANAGER_HH
...
namespace NRS
{
  namespace Message
  {
    /// The manager for the QueryMaxPort Variable type.
    class QueryMaxPortManager : public Base::VariableManager
    {
    public:
      /// Default constructor.
      /**
       *
       * This is the constructor for the basic QueryMaxPortManager.
       *
       **/
      QueryMaxPortManager();

      /// Destructor.
      virtual ~QueryMaxPortManager()
      {
      }
...
#endif //ndef _QUERY_MAXPORT_MANAGER_HH
