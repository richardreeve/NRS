...
#ifndef _QUERY_CTYPE_MANAGER_HH
#define _QUERY_CTYPE_MANAGER_HH
...
namespace NRS
{
  namespace Message
  {
    /// The manager for the QueryCType Variable type.
    class QueryCTypeManager : public Base::VariableManager
    {
    public:
      /// Default constructor.
      /**
       *
       * This is the constructor for the basic QueryCTypeManager.
       *
       **/
      QueryCTypeManager();

      /// Destructor.
      virtual ~QueryCTypeManager()
      {
      }
...
#endif //ndef _QUERY_CTYPE_MANAGER_HH
