...
#ifndef _REPLY_LOG_MANAGER_HH
#define _REPLY_LOG_MANAGER_HH
...
namespace NRS
{
  ...
  namespace Message
  {
    ...
    /// The manager for the ReplyLog Variable type.
    /** 
     *
     ...
     *
     **/
    class ReplyLogManager : public ReplyManager
    {
    public:
      /// Default constructor.
      /**
       *
       * This is the constructor for the basic ReplyLogManager.
       *
       **/
      ReplyLogManager();

      /// Destructor.
      virtual ~ReplyLogManager()
      {
      }
       ...
       * \param theLog log route to send out
       * \param logPMLNotBMF language of log
       *
       **/
...
#endif //ndef _REPLY_LOG_MANAGER_HH
