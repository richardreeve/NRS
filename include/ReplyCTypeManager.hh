...
#ifndef _REPLY_CTYPE_MANAGER_HH
#define _REPLY_CTYPE_MANAGER_HH
...
namespace NRS
{
  namespace Message
  {
    /// The manager for the ReplyCType Variable type.
    /** 
     *
     ...
     *
     **/
    class ReplyCTypeManager : public Base::VariableManager
    {
    public:
      /// Default constructor.
      /**
       *
       * This is the constructor for the basic ReplyCTypeManager.
       *
       **/
      ReplyCTypeManager();

      /// Destructor.
      virtual ~ReplyCTypeManager()
      {
      }
...
#endif //ndef _REPLY_CTYPE_MANAGER_HH
