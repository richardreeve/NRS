...
#ifndef _REPLY_NUMLOG_MANAGER_HH
#define _REPLY_NUMLOG_MANAGER_HH
...
namespace NRS
{
  ...
  namespace Message
  {
    ...
    /// The manager for the ReplyNumLog Variable type.
    /** 
     *
     ...
     *
     **/
    class ReplyNumLogManager : public ReplyManager
    {
    public:
      /// Default constructor.
      /**
       *
       * This is the constructor for the basic ReplyNumLogManager.
       *
       **/
      ReplyNumLogManager();

      /// Destructor.
      virtual ~ReplyNumLogManager()
      {
      }
       ...
       * \param numLog number of logs on component
       *
       **/
...
#endif //ndef _REPLY_NUMLOG_MANAGER_HH
