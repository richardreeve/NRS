...
namespace NRS
{
  namespace Message
  {
    /// The manager for the DeleteLink Variable type.
    /** 
     *
     ...
     *
     **/
    class DeleteLinkManager : public Base::VariableManager
    {
    public:
      /// Default constructor.
      /**
       *
       * This is the constructor for the basic DeleteLinkManager.
       *
       **/
      DeleteLinkManager();

      /// Destructor.
      virtual ~DeleteLinkManager()
      {
      }
...
#endif //ndef _DELETE_LINK_MANAGER_HH
