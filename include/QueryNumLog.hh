...
#ifndef _QUERY_NUMLOG_HH
#define _QUERY_NUMLOG_HH
...
namespace NRS
{
  ...
  namespace Message
  {
    ...
    /// A special variable type to handle QueryNumLog messages.
    /**
     *
     * The QueryNumLog class represents all message senders and receivers
     * which deal with QueryNumLog messages
     *
     **/
    class QueryNumLog : public NRS::Base::Variable

    {
    public:
      /// Constructor for QueryNumLog Variables.
      /**
       *
       * \param aName the name of the QueryNumLog Variable being built.
       *
       **/
      QueryNumLog( std::string aName );
    ...
    protected:
      /// Pointer to ReplyNumLog variable, with which QueryNumLog communicates
      ReplyNumLog *iReplyNumLog;
    };
  }
}

#endif //ndef _QUERY_NUMLOG_HH
