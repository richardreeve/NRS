...
#ifndef _REPLY_CSL_MANAGER_HH
#define _REPLY_CSL_MANAGER_HH
...
namespace NRS
{
  namespace Message
  {
    /// The manager for the ReplyCSL Variable type.
    /** 
     *
     ...
     *
     **/
    class ReplyCSLManager : public Base::VariableManager
    {
    public:
      /// Default constructor.
      /**
       *
       * This is the constructor for the basic ReplyCSLManager.
       *
       **/
      ReplyCSLManager();

      /// Destructor.
      virtual ~ReplyCSLManager()
      {
      }
...
#endif //ndef _REPLY_CSL_MANAGER_HH
