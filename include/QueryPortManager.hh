...
#ifndef _QUERY_PORT_MANAGER_HH
#define _QUERY_PORT_MANAGER_HH
...
namespace NRS
{
  namespace Message
  {
    /// The manager for the QueryPort Variable type.
    class QueryPortManager : public Base::VariableManager
    {
    public:
      /// Default constructor.
      /**
       *
       * This is the constructor for the basic QueryPortManager.
       *
       **/
      QueryPortManager();

      /// Destructor.
      virtual ~QueryPortManager()
      {
      }
...
#endif //ndef _QUERY_PORT_MANAGER_HH
