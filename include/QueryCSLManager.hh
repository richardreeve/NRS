...
#ifndef _QUERY_CSL_MANAGER_HH
#define _QUERY_CSL_MANAGER_HH
...
namespace NRS
{
  namespace Message
  {
    /// The manager for the QueryCSL Variable type.
    class QueryCSLManager : public Base::VariableManager
    {
    public:
      /// Default constructor.
      /**
       *
       * This is the constructor for the basic QueryCSLManager.
       *
       **/
      QueryCSLManager();

      /// Destructor.
      virtual ~QueryCSLManager()
      {
      }
...
#endif //ndef _QUERY_CSL_MANAGER_HH
