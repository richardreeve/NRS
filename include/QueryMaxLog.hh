...
#ifndef _QUERY_MAXLOG_HH
#define _QUERY_MAXLOG_HH
...
namespace NRS
{
  ...
  namespace Message
  {
    ...
    /// A special variable type to handle QueryMaxLog messages.
    /**
     *
     * The QueryMaxLog class represents all message senders and receivers
     * which deal with QueryMaxLog messages
     *
     **/
    class QueryMaxLog : public NRS::Base::Variable

    {
    public:
      /// Constructor for QueryMaxLog Variables.
      /**
       *
       * \param aName the name of the QueryMaxLog Variable being built.
       *
       **/
      QueryMaxLog( std::string aName );
    ...
    protected:
      /// Pointer to ReplyMaxLog variable, with which QueryMaxLog communicates
      ReplyMaxLog *iReplyMaxLog;
    };
  }
}

#endif //ndef _QUERY_MAXLOG_HH
