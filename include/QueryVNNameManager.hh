...
#ifndef _QUERY_VNNAME_MANAGER_HH
#define _QUERY_VNNAME_MANAGER_HH
...
namespace NRS
{
  namespace Message
  {
    /// The manager for the QueryVNName Variable type.
    class QueryVNNameManager : public Base::VariableManager
    {
    public:
      /// Default constructor.
      /**
       *
       * This is the constructor for the basic QueryVNNameManager.
       *
       **/
      QueryVNNameManager();

      /// Destructor.
      virtual ~QueryVNNameManager()
      {
      }
...
#endif //ndef _QUERY_VNNAME_MANAGER_HH
