...
#ifndef _QUERY_NUMLOG_MANAGER_HH
#define _QUERY_NUMLOG_MANAGER_HH
...
namespace NRS
{
  ...
  namespace Message
  {
    /// The manager for the QueryNumLog Variable type.
    class QueryNumLogManager : public QueryManager
    {
    public:
      /// Default constructor.
      /**
       *
       * This is the constructor for the basic QueryNumLogManager.
       *
       **/
      QueryNumLogManager();

      /// Destructor.
      virtual ~QueryNumLogManager()
      {
      }
      ...
      /// Send message to get a NumLog from off component
      /**
       *
       * \param theTarget the route for the message
...
#endif //ndef _QUERY_NUMLOG_MANAGER_HH
