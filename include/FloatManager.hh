...
#ifndef _FLOAT_MANAGER_HH
#define _FLOAT_MANAGER_HH
...
namespace NRS
{
  namespace Type
  {
    /// The manager for the Float Variable type.
    /** 
     *
     * This is the base class for all managers of Variables with 1 float
     * argument - Variables of Float type.
     *
     **/
    class FloatManager : public Base::VariableManager
    {
    public:
      /// Default constructor.
      /**
       *
       * This is the constructor for the basic FloatManager.
       *
       **/
      FloatManager();
       ...
       *
       **/
      FloatManager( std::string aMessageName,
		    std::string aDisplayName,
		    bool isUnit );

      /// Destructor.
      virtual ~FloatManager()
      {
      }
