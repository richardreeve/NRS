...
namespace NRS
{
  namespace Message
  {
    /// The manager for the ReplyVNName Variable type.
    /** 
     *
     ...
     *
     **/
    class ReplyVNNameManager : public Base::VariableManager
    {
    public:
      /// Default constructor.
      /**
       *
       * This is the constructor for the basic ReplyVNNameManager.
       *
       **/
      ReplyVNNameManager();

      /// Destructor.
      virtual ~ReplyVNNameManager()
      {
      }
...
#endif //ndef _REPLY_VNNAME_MANAGER_HH
