...
#ifndef _QUERY_NUMBERTYPE_MANAGER_HH
#define _QUERY_NUMBERTYPE_MANAGER_HH
...
namespace NRS
{
  ...
  namespace Message
  {
    class QueryNumberType;

    /// The manager for the QueryNumberType Variable type.
    class QueryNumberTypeManager : public QueryManager
    {
    public:
      /// Default constructor.
      /**
       *
       * This is the constructor for the basic QueryNumberTypeManager.
       *
       **/
      QueryNumberTypeManager();

      /// Destructor.
      virtual ~QueryNumberTypeManager()
      {
      }
      ...
      /// Send message to get a NumberType from off component
      /**
       *
       * \param theTarget the route for the message
...
#endif //ndef _QUERY_NUMBERTYPE_MANAGER_HH
