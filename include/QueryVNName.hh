...
#ifndef _QUERY_VNNAME_HH
#define _QUERY_VNNAME_HH
...
namespace NRS
{
  namespace Message
  {
    ...
    /// A special variable type to handle QueryVNName messages.
    /**
     *
     * The QueryVNName class represents all message senders and receivers
     * which deal with QueryVNName messages
     *
     **/
    class QueryVNName : public Base::Variable

    {
    public:
      /// Constructor for QueryVNName Variables.
      /**
       *
       * \param aName the name of the QueryVNName Variable being built.
       *
       **/
      QueryVNName( std::string aName );
      
      /// Destructor.
      virtual ~QueryVNName();

      /// Request a VNName from a VNID
      /**
       *
       * This method requests the QueryVNName variable to give the
    ...
    protected:
      ...
      /// Pointer to ReplyVNName variable, with which QueryVNName communicates
      ReplyVNName *iReplyVNNamePtr;
