...
#ifndef _QUERY_MANAGER_HH
#define _QUERY_MANAGER_HH
...
namespace NRS
{
  ...
  namespace Message
  {
    /// The manager for the QueryVNID Variable type.
    /** 
     *
     ...
     *
     **/
    class QueryManager : public NRS::Base::VariableManager
    {
    public:
      /// Default constructor.
      /**
       ...
       *
       **/
       QueryManager( std::string aMessage, std::string displayName, 
		     int numSeg );
      ...
      /// Extract a return route from a PML message
      /**
       *
       ...
       *
       **/
      bool extractReturnTarget( std::map< std::string,
      ...
      /// Extract a return route from a BMF message
      /**
       *
       ...
       *
       **/
      bool extractReturnTarget( char *&data,
				bool intelligent,
				const char* intMap[],
				Base::Target &returnTarget );
      ...
      /// Insert a return route into a PML message
      /**
       *
       * \param NRSAttrMap map of nrs specific attributes for variable
       * \param intelligent whether the message is intelligent
       * \param returnTarget the return route to insert
       *
       **/
      void insertReturnTarget( std::map< std::string,
			       std::string > &NRSAttrMap,
			       std::map< std::string,
			       std::string > &attrMap,
			       bool &intelligent,
      ...
      /// Insert a return route into a BMF message
      /**
       *
       ...
       *
       **/
      void insertReturnTarget( char *&msg, size_t &alloc,
