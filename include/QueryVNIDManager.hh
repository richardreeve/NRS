...
#ifndef _QUERY_VNID_MANAGER_HH
#define _QUERY_VNID_MANAGER_HH
...
namespace NRS
{
  namespace Message
  {
    ...
    class QueryVNIDManager : public Base::VariableManager
    {
    public:
      /// Default constructor.
      /**
       *
       * This is the constructor for the basic QueryVNIDManager.
       *
       **/
      QueryVNIDManager();

      /// Destructor.
      virtual ~QueryVNIDManager()
      {
      }
...
#endif //ndef _QUERY_VNID_MANAGER_HH
