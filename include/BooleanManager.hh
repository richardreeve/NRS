...
#ifndef _BOOLEAN_MANAGER_HH
#define _BOOLEAN_MANAGER_HH
...
namespace NRS
{
  namespace Type
  {
    /// The manager for the Boolean Variable type.
    /** 
     *
     * This is the base class for all managers of Variables with 1 boolean
     * argument - Variables of Boolean type.
     *
     **/
    class BooleanManager : public Base::VariableManager
    {
    public:
      /// Default constructor.
      /**
       *
       * This is the constructor for the basic BooleanManager.
       *
       **/
      BooleanManager();
       ...
       *
       **/
      BooleanManager( std::string aMessageName,
		      std::string aDisplayName,
		      bool isUnit );

      /// Destructor.
      virtual ~BooleanManager()
      {
      }
       ...
       *
       * \return segment of same type as variable, belonging to caller
       *
       **/
...
#endif //ndef _BOOLEAN_MANAGER_HH
