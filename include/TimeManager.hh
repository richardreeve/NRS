...
#ifndef _TIME_MANAGER_HH
#define _TIME_MANAGER_HH
...
namespace NRS
{
  namespace Unit
  {
    /// The manager for the Time Units.
    /** 
     *
     * This is the class for the Time Manager
     *
     **/
    class TimeManager : public Type::FloatManager
    {
    public:
      /// Constructor.
      ...
      /**
       *
       * This is the constructor for the basic TimeManager.
       *
       **/
      TimeManager();
       ...
       *
       **/
      TimeManager( std::string aMessageName,
      ...
      /// Repository for text string "Time"
      /**
       *
