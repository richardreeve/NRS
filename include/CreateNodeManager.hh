...
#ifndef _CREATE_NODE_MANAGER_HH
#define _CREATE_NODE_MANAGER_HH
...
namespace NRS
{
  namespace Message
  {
    /// The manager for the CreateNode Variable type.
    /** 
     *
     * This is the base class for all managers of Variables which can
     * create nodes - it calls the node factories to do the construction
     *
     **/
    class CreateNodeManager : public Base::VariableManager
    {
    public:
      /// Default constructor.
      /**
       *
       * This is the constructor for the basic CreateNodeManager.
       *
       **/
      CreateNodeManager();

      /// Destructor.
      virtual ~CreateNodeManager()
      {
      }
...
#endif //ndef _CREATE_NODE_MANAGER_HH
