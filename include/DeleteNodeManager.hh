...
#ifndef _DELETE_NODE_MANAGER_HH
#define _DELETE_NODE_MANAGER_HH
...
namespace NRS
{
  namespace Message
  {
    /// The manager for the DeleteNode Variable type.
    /** 
     *
     * This is the base class for all managers of Variables which can
     * delete nodes - it calls the node factories to do the construction
     *
     **/
    class DeleteNodeManager : public Base::VariableManager
    {
    public:
      /// Default constructor.
      /**
       *
       * This is the constructor for the basic DeleteNodeManager.
       *
       **/
      DeleteNodeManager();

      /// Destructor.
      virtual ~DeleteNodeManager()
      {
      }
...
#endif //ndef _DELETE_NODE_MANAGER_HH
