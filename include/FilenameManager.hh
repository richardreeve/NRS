...
#ifndef _FILENAME_MANAGER_HH
#define _FILENAME_MANAGER_HH
...
namespace NRS
{
  namespace Unit
  {
    /// The manager for the Filename Units.
    /** 
     *
     * This is the class for the Filename Manager
     *
     **/
    class FilenameManager : public Type::StringManager
    {
    public:
      /// Constructor.
      ...
      /**
       *
       * This is the constructor for the basic FilenameManager.
       *
       **/
      FilenameManager();
       ...
       *
       **/
      FilenameManager( std::string aMessageName,
...
#endif //ndef _FILENAME_MANAGER_HH
