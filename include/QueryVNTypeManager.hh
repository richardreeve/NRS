...
namespace NRS
{
  namespace Message
  {
    /// The manager for the QueryVNType Variable type.
    class QueryVNTypeManager : public Base::VariableManager
    {
    public:
      /// Default constructor.
      /**
       *
       * This is the constructor for the basic QueryVNTypeManager.
       *
       **/
      QueryVNTypeManager();

      /// Destructor.
      virtual ~QueryVNTypeManager()
      {
      }
...
#endif //ndef _QUERY_VNTYPE_MANAGER_HH
