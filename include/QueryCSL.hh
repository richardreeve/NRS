...
#ifndef _QUERY_CSL_HH
#define _QUERY_CSL_HH
...
namespace NRS
{
  namespace Message
  {
    ...
    /// A special variable type to handle QueryCSL messages.
    /**
     *
     * The QueryCSL class represents all message senders and receivers
     * which deal with QueryCSL messages
     *
     **/
    class QueryCSL : public Base::Variable

    {
    public:
      /// Constructor for QueryCSL Variables.
      /**
       *
       * \param aName the name of the QueryCSL Variable being built.
       *
       **/
      QueryCSL( std::string aName );
      ...
      /**
       *
       * This method requests the QueryCSL variable to give the type
       * of another variable
       *
    ...
    protected:
      ...
      /// Pointer to ReplyCSL variable, with which QueryCSL communicates
      ReplyCSL *iReplyCSLPtr;
