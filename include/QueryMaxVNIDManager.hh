...
namespace NRS
{
  namespace Message
  {
    ...
    /// The manager for the QueryMaxVNID Variable type.
    class QueryMaxVNIDManager : public Base::VariableManager
    {
    public:
      /// Default constructor.
      /**
       *
       * This is the constructor for the basic QueryMaxVNIDManager.
       *
       **/
      QueryMaxVNIDManager();

      /// Destructor.
      virtual ~QueryMaxVNIDManager()
      {
      }
...
#endif //ndef _QUERY_MAX_VNID_MANAGER_HH
