...
#ifndef _REPLY_NUMBERTYPE_MANAGER_HH
#define _REPLY_NUMBERTYPE_MANAGER_HH
...
namespace NRS
{
  ...
  namespace Message
  {
    ...
    /// The manager for the ReplyNumberType Variable type.
    /** 
     *
     * This is the base class for all managers of Variables which can
     * reply to number type queries
     *
     **/
    class ReplyNumberTypeManager : public ReplyManager
    {
    public:
      /// Default constructor.
      /**
       *
       * This is the constructor for the basic ReplyNumberTypeManager.
       *
       **/
      ReplyNumberTypeManager();

      /// Destructor.
      virtual ~ReplyNumberTypeManager()
      {
      }
...
#endif //ndef _REPLY_NUMBERTYPE_MANAGER_HH
