...
#ifndef _QUERY_LANGUAGE_MANAGER_HH
#define _QUERY_LANGUAGE_MANAGER_HH
...
namespace NRS
{
  ...
  namespace Message
  {
    ...
    /// The manager for the QueryLanguage Variable type.
    class QueryLanguageManager : public QueryManager
    {
    public:
      /// Default constructor.
      /**
       *
       * This is the constructor for the basic QueryLanguageManager.
       *
       **/
      QueryLanguageManager();

      /// Destructor.
      virtual ~QueryLanguageManager()
      {
      }
      ...
      /// Send message to get a Language from off component
      /**
       *
       * \param theTarget the route for the message
...
#endif //ndef _QUERY_LANGUAGE_MANAGER_HH
