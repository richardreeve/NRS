...
namespace NRS
{
  namespace Message
  {
    /// The manager for the ReplyPort Variable type.
    /** 
     *
     ...
     *
     **/
    class ReplyPortManager : public Base::VariableManager
    {
    public:
      /// Default constructor.
      /**
       *
       * This is the constructor for the basic ReplyPortManager.
       *
       **/
      ReplyPortManager();

      /// Destructor.
      virtual ~ReplyPortManager()
      {
      }
...
#endif //ndef _REPLY_PORT_MANAGER_HH
