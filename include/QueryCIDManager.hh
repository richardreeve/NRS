...
#ifndef _QUERY_CID_MANAGER_HH
#define _QUERY_CID_MANAGER_HH
...
namespace NRS
{
  namespace Message
  {
    /// The manager for the QueryCID Variable type.
    /** 
     *
     ...
     *
     **/
    class QueryCIDManager : public Base::VariableManager
    {
    public:
      /// Default constructor.
      /**
       *
       * This is the constructor for the basic QueryCIDManager.
       *
       **/
      QueryCIDManager();

      /// Destructor.
      virtual ~QueryCIDManager()
      {
      }
...
#endif //ndef _QUERY_CID_MANAGER_HH
