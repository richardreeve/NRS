...
#ifndef _VNNAME_MANAGER_HH
#define _VNNAME_MANAGER_HH
...
namespace NRS
{
  namespace Unit
  {
    /// The manager for the VNName Units.
    /** 
     *
     * This is the class for the VNName Manager
     *
     **/
    class VNNameManager : public Type::StringManager
    {
    public:
      /// Constructor.
      ...
      /**
       *
       * This is the constructor for the basic VNNameManager.
       *
       **/
      VNNameManager();
       ...
       *
       **/
      VNNameManager( std::string aMessageName,
		     std::string aDisplayName );

      /// Destructor.
      virtual ~VNNameManager()
      {
      }
