...
#ifndef _REPLY_VNTYPE_MANAGER_HH
#define _REPLY_VNTYPE_MANAGER_HH
...
namespace NRS
{
  namespace Message
  {
    /// The manager for the ReplyVNType Variable type.
    /** 
     *
     ...
     *
     **/
    class ReplyVNTypeManager : public Base::VariableManager
    {
    public:
      /// Default constructor.
      /**
       *
       * This is the constructor for the basic ReplyVNTypeManager.
       *
       **/
      ReplyVNTypeManager();

      /// Destructor.
      virtual ~ReplyVNTypeManager()
      {
      }
...
#endif //ndef _REPLY_VNTYPE_MANAGER_HH
