...
#ifndef _CREATE_LINK_MANAGER_HH
#define _CREATE_LINK_MANAGER_HH
...
namespace NRS
{
  namespace Message
  {
    /// The manager for the CreateLink Variable type.
    /** 
     *
     ...
     *
     **/
    class CreateLinkManager : public Base::VariableManager
    {
    public:
      /// Default constructor.
      /**
       *
       * This is the constructor for the basic CreateLinkManager.
       *
       **/
      CreateLinkManager();

      /// Destructor.
      virtual ~CreateLinkManager()
      {
      }
...
#endif //ndef _CREATE_LINK_MANAGER_HH
