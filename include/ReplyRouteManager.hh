...
#ifndef _REPLY_ROUTE_MANAGER_HH
#define _REPLY_ROUTE_MANAGER_HH
...
namespace NRS
{
  namespace Message
  {
    /// The manager for the ReplyRoute Variable type.
    class ReplyRouteManager : public Base::VariableManager
    {
    public:
      /// Default constructor.
      /**
       *
       * This is the constructor for the basic ReplyRouteManager.
       *
       **/
      ReplyRouteManager();

      /// Destructor.
      virtual ~ReplyRouteManager()
      {
      }
...
#endif //ndef _REPLY_ROUTE_MANAGER_HH
