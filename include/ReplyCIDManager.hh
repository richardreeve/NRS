...
namespace NRS
{
  namespace Message
  {
    /// The manager for the ReplyCID Variable type.
    /** 
     *
     ...
     *
     **/
    class ReplyCIDManager : public Base::VariableManager
    {
    public:
      /// Default constructor.
      /**
       *
       * This is the constructor for the basic ReplyCIDManager.
       *
       **/
      ReplyCIDManager();

      /// Destructor.
      virtual ~ReplyCIDManager()
      {
      }
...
#endif //ndef _REPLY_CID_MANAGER_HH
