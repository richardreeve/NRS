...
#ifndef _QUERY_ROUTE_MANAGER_HH
#define _QUERY_ROUTE_MANAGER_HH
...
namespace NRS
{
  namespace Message
  {
    /// The manager for the QueryRoute Variable type.
    class QueryRouteManager : public Base::VariableManager
    {
    public:
      /// Default constructor.
      /**
       *
       * This is the constructor for the basic QueryRouteManager.
       *
       **/
      QueryRouteManager();

      /// Destructor.
      virtual ~QueryRouteManager()
      {
      }
...
#endif //ndef _QUERY_ROUTE_MANAGER_HH
