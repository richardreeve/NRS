...
#ifndef _QUERY_MAXLOG_MANAGER_HH
...
namespace NRS
{
  ...
  namespace Message
  {
    /// The manager for the QueryMaxLog Variable type.
    class QueryMaxLogManager : public QueryManager
    {
    public:
      /// Default constructor.
      /**
       *
       * This is the constructor for the basic QueryMaxLogManager.
       *
       **/
      QueryMaxLogManager();

      /// Destructor.
      virtual ~QueryMaxLogManager()
      {
      }
      ...
      /// Send message to get a MaxLog from off component
      /**
       *
       * \param theTarget the route for the message
...
#endif //ndef _QUERY_MAXLOG_MANAGER_HH
